...
import type { ProjectFile } from '@/app/_lib/types';
...
export function FileListItem({ file, onDownload, onDelete }: FileListItemProps) {
  return (
    <div className="flex items-center gap-3 p-3 bg-background border border-gray-200 rounded-md">
      ...
      <div className="flex items-center gap-1 shrink-0">
        <button
          onClick={onDownload}
          className="p-2 text-primary-400 hover:text-primary-700 hover:bg-primary-50 rounded-md transition-colors duration-100"
          aria-label="다운로드"
        >
        ...
        <button
          onClick={onDelete}
          className="p-2 text-primary-400 hover:text-danger-600 hover:bg-danger-50 rounded-md transition-colors duration-100"
          aria-label="삭제"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
